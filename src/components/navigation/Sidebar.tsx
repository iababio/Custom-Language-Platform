  ...
  return (
    <div className="w-51 bg-gray-100 border-r border-gray-100 flex flex-col">
      ...
      <div className="flex-1 overflow-y-auto">
        <ul className="p-2">
          <li className="mb-0">
            <a href="#" className="flex items-center px-4 py-1 text-gray-700 rounded hover:bg-white">
              <Home size={12} className="mr-3 text-gray-500" />
              <span>QA Tests</span>
            </a>
          </li>
          <li className="mb-0">
            <a href="#" className="flex items-center px-4 py-1 text-gray-700 rounded hover:bg-bg-white">
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          <ul>
            <li className="mb-1">
              <a href="#" className="flex items-center px-2 py-1 text-sm text-gray-700 rounded hover:bg-bg-white">
            ...
            <li className="mb-1">
              <a href="#" className="flex items-center px-2 py-1 text-sm text-gray-700 rounded hover:bg-bg-white">
                ...
                <span>Labeling</span>
                      ...
                      <li className="mb-0">
            <a href="#" className="flex items-center px-2 py-1 text-gray-700 rounded hover:bg-bg-white">
        ...
        <div className="p-4 border-t border-gray-200">
          ...
          <ul>
            <li className="mb-1">
              <a href="#" className="flex items-center py-1 text-sm text-gray-700 rounded hover:bg-white">
            ...
            <li className="mb-1">
              <a href="#" className="flex items-center px-1 py-1 text-sm text-gray-700 rounded hover:bg-white">
      ...
      <div className="p-4 border-t border-gray-200">
        <ul>
          <li className="mb-1">
            <a href="#" className="flex items-center px-4 text-gray-700 rounded hover:bg-white">
      ...
      <div className="p-4 border-gray-200">
        <div className="flex items-center">
          ...
          <div className="flex-1">
            ...
            <p className="text-xs text-gray-500">{user?.primaryEmailAddress?.emailAddress || "email"}</p>
          </div>
        </div>
      </div>
    </div>
